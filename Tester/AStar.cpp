...
TEST_CASE( "A simple case for ASTAR", "[ASTAR]" ) {
    SECTION( "Minimal working examples" ) {
        SECTION( "Example 1" ) {
            ...
            vector<pair<string, int>>h={{"AR",366},{"BUC",0},{"ZER",374},{"ORA",380},{"TIM",329},{"LUG",244},{"MEH",241},{"DOB",242}
            , {"CRA", 160}, {"RIM", 193}, {"SIB", 253}, {"FAG", 178}, {"PIT", 98}};
